...
function initProductSlider() {
  ...
  const productMediaData = {
    passenger: {
      ...
      slides: [
        { type: 'image', src: 'assets/lift/passenger-elevators/photos/Door-CO.jpg', title: 'Center Opening Automatic Landing Doors', caption: 'High-speed automated center-opening landing doors with integrated safety light curtains' },
        { type: 'video', src: 'assets/lift/passenger-elevators/videos/Rose Gold.mp4', poster: 'assets/lift/passenger-elevators/photos/WhatsApp Image 2026-09-10 at 4.50.30 PM.jpeg', title: 'Rose Gold Titanium Luxury Cabin', caption: 'Custom etched titanium rose gold mirror panels with illuminated ceiling' },
        { type: 'image', src: 'assets/lift/passenger-elevators/photos/SS cabin.jpg', title: 'Mirror Stainless Steel Luxury Cabin', caption: 'High-end SS 304 mirror finish with integrated LED spotlight canopy' },
        { type: 'video', src: 'assets/lift/passenger-elevators/videos/Lift with Structure.mp4', poster: 'assets/lift/passenger-elevators/photos/WhatsApp Image 2026-09-10 at 10.53.50 AM.jpeg', title: 'Self-Supporting Structural Hoistway', caption: 'Full steel and glass hoistway tower with live passenger car travel' },
        ...
        { type: 'image', src: 'assets/lift/passenger-elevators/photos/Glass Door.jpeg', title: 'Framed Panoramic Glass Landing Entrance', caption: 'Architectural clear tempered glass landing entrance with satin stainless frames' },
        { type: 'video', src: 'assets/lift/passenger-elevators/videos/Back Finish.mp4', poster: 'assets/lift/passenger-elevators/photos/SS cabin.jpg', title: 'Mirror Finish Architectural Wall Panel', caption: 'Precision back panel finish with stainless steel mirror reflective treatment' },
        { type: 'image', src: 'assets/lift/passenger-elevators/photos/Flooring.png', title: 'Custom Floor Medallion & Granite Inlay', caption: 'Laser-cut marble and heavy-duty composite floor finishes engineered for high traffic' },
        { type: 'video', src: 'assets/lift/passenger-elevators/videos/SS 304 With Glass Door.mp4', poster: 'assets/lift/passenger-elevators/photos/Glass Door.jpeg', title: 'SS 304 Cabin with Glass Landing Doors', caption: 'Telescopic motorized glass landing doors combined with high-grade stainless steel cabin' },
        { type: 'image', src: 'assets/lift/passenger-elevators/photos/WhatsApp Image 2026-09-10 at 4.50.30 PM.jpeg', title: 'Imperial Gold Luxury Cabin Interior', caption: 'Custom imperial gold mirror finish tailored for luxury hotels and prestige corporate headquarters' },
        { type: 'video', src: 'assets/lift/passenger-elevators/videos/SS Gold.mp4', poster: 'assets/lift/passenger-elevators/photos/WhatsApp Image 2026-09-10 at 4.50.30 PM (1).jpeg', title: 'Gold Etched Decorative Passenger Lift', caption: 'Exclusive gold hairline and mirror etched panels with digital hall display' },
        { type: 'image', src: 'assets/lift/passenger-elevators/photos/WhatsApp Image 2026-09-10 at 4.50.30 PM (1).jpeg', title: 'Precision Stainless Steel Landing Architrave', caption: 'Wide jamb flush architrave with integrated digital directional indicators' },
        { type: 'video', src: 'assets/lift/passenger-elevators/videos/WhatsApp Video 2026-06-21 at 8.56.39 AM.mp4', poster: 'assets/lift/passenger-elevators/photos/Door-CO.jpg', title: 'High-Speed Shaft Commissioning', caption: 'Precision guide rail alignment and vibration-free high-speed shaft travel' },
        { type: 'image', src: 'assets/lift/passenger-elevators/photos/WhatsApp Image 2026-09-10 at 4.50.31 PM.jpeg', title: 'Illuminated Touch COP & Digital Matrix', caption: 'Full-height car operating panel with capacitive touch buttons and live floor indicator' },
    ...
    hospital: {
      ...
      slides: [
        ...
        { type: 'image', src: 'assets/lift/hospital-elevators/photos/WhatsApp Image 2023-01-17 at 12.48.00 PM.jpeg', title: 'Deep Cabin Stretcher Dimension Layout', caption: 'Extended cabin depth engineered to accommodate ICU beds, stretchers, and life-support equipment' },
        { type: 'image', src: 'assets/lift/hospital-elevators/photos/WhatsApp Image 2023-01-17 at 12.48.02 PM.jpeg', title: 'Hygienic Flush Landing Entrance & Wide Door', caption: 'Flush threshold landing station designed for smooth wheel transit with zero vibration' },
        { type: 'image', src: 'assets/lift/hospital-elevators/photos/WhatsApp Image 2023-01-17 at 12.48.02 PM (1).jpeg', title: 'Smooth Gurney Loading Platform', caption: 'Heavy-gauge non-slip vinyl flooring and reinforced door sills for gurney roll-in' },
        { type: 'image', src: 'assets/lift/hospital-elevators/photos/WhatsApp Image 2023-01-17 at 12.48.06 PM (1).jpeg', title: 'Antibacterial SS 304 Walls & Protective Bumpers', caption: 'Seamless antibacterial stainless steel panels with shock-absorbing wall protection rails' },
    ...
    auto: {
      ...
      slides: [
        { type: 'video', src: 'assets/lift/automobile-elevators/videos/VIDEO.mp4', poster: 'assets/lift/automobile-elevators/photos/8 Panels Auto Doors.jpg', title: 'Multi-Level Automotive Vertical Transport', caption: 'Automated vehicle hoist system engineered for car showrooms and multi-level parking' },
        { type: 'image', src: 'assets/lift/automobile-elevators/photos/8 Panels Auto Doors.jpg', title: '8-Panel Telescopic Heavy Vehicle Automatic Doors', caption: 'Ultra-wide multi-panel automated sliding doors engineered for oversized SUVs and commercial vans' },
        { type: 'video', src: 'assets/lift/automobile-elevators/videos/WhatsApp Video 2026-06-08 at 11.03.50 AM.mp4', poster: 'assets/lift/automobile-elevators/photos/WhatsApp Image 2025-03-24 at 10.08.39_684ef7ac.jpg', title: 'Heavy-Duty Hydraulic Car Platform Travel', caption: 'High-tonnage hydraulic automobile lift in live vertical operation' },
        { type: 'image', src: 'assets/lift/automobile-elevators/photos/WhatsApp Image 2025-03-24 at 10.08.39_684ef7ac.jpg', title: 'Reinforced Vehicle Platform Floor & Wheel Guides', caption: 'Tear-drop steel chequered plate flooring with integrated wheel stop guides and high-load capacity' },
    ...
    service: {
      ...
      slides: [
        { type: 'video', src: 'assets/lift/dumbwaiters/videos/WhatsApp Video 2026-06-09 at 6.02.04 PM.mp4', poster: 'assets/lift/dumbwaiters/photos/2L7A2474.jpg', title: 'Electric Commercial Dumbwaiter in Motion', caption: 'Rapid vertical pantry transport operating quietly between kitchen and dining floors' },
        { type: 'image', src: 'assets/lift/dumbwaiters/photos/2L7A2474.jpg', title: 'Commercial Grade Food & Cargo Dumbwaiter Cabin', caption: 'Heavy-duty food-grade SS 304 cabin with removable shelving for banquet service' },
        { type: 'image', src: 'assets/lift/dumbwaiters/photos/2L7A2485.jpg', title: 'Bespoke Compact Dumbwaiter Bi-Parting Door', caption: 'Vertical bi-parting counter-balanced stainless steel doors with electromagnetic safety interlocks' },
        ...
        { type: 'image', src: 'assets/lift/dumbwaiters/photos/WhatsApp Image 2023-01-19 at 11.45.52 AM.jpeg', title: 'Restaurant Service Vertical Dumbwaiter Station', caption: 'Compact kitchen service lift installation with ergonomic floor-level call station' },
        { type: 'image', src: 'assets/lift/dumbwaiters/photos/WhatsApp Image 2023-06-16 at 3.59.02 PM.jpeg', title: 'Hospitality Bi-Parting Stainless Steel Shutter', caption: 'Satin finish SS 304 shutter with smooth bi-parting motion and food hygiene seal' },
        { type: 'image', src: 'assets/lift/dumbwaiters/photos/WhatsApp Image 2023-06-16 at 5.27.38 PM.jpeg', title: 'Compact Hoistway Mechanism & Shelving', caption: 'Self-contained tower framework minimizing structural load on building walls' },
        { type: 'image', src: 'assets/lift/dumbwaiters/photos/WhatsApp Image 2023-06-19 at 1.44.55 PM.jpeg', title: 'Multi-Tier Internal Tray Dumbwaiter Car', caption: 'Modular stainless steel compartment trays designed for multi-course meal transit' },
        { type: 'image', src: 'assets/lift/dumbwaiters/photos/WhatsApp Image 2023-06-19 at 1.49.25 PM.jpeg', title: 'Stainless Steel Landing Call Station with Key Switch', caption: 'Digital arrival chime, floor indicator, and restricted-access supervisor key switch' },
